					...
					<section class="panel">
						...
						<div class="panel-body">
							<ul class="grid cs-style-3">
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/kaca.JPG")?>" alt="img04">
										<figcaption>
											<h3>Cermin</h3>
								...
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/matadalam.JPG")?>" alt="img01">
										<figcaption>
											<h3>Mata Dalam</h3>
								...
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/snellius.JPG")?>" alt="img02">
										<figcaption>
								...
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/asam.JPG")?>" alt="img03">
										<figcaption>
								...
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/ototmata.JPG")?>" alt="img04">
										<figcaption>
											<h3>Otot Mata</h3>
								...
								<li>
									<figure>
										<img src="<?php echo base_url("assets/img/gallery/mataluar.jpg")?>" alt="img06">
										<figcaption>
											<h3>Mata Luar</h3>
