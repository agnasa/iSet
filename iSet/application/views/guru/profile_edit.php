							  ...
							  <aside class="profile-nav col-lg-3">
								  <section class="panel">
									  ...
									  <ul class="nav nav-pills nav-stacked">
										  <li><a href="<?php echo site_url("guru/profile")?>"> <i class="icon-user"></i> Profile</a></li>
										  ...
										  <li  class="active"><a href="<?php echo site_url("guru/profile_edit")?>"> <i class="icon-edit"></i> Edit profile</a></li>
									  </ul>
