	...
	<body>
		...
		<section id="container" class="">
			...
			<header class="header white-bg">
				...
				<!--logo start-->
				<a href="#" class="logo" >i<span>Pos</span></a>
				<!--logo end-->
				...
				<?php
					echo form_close();
					echo form_open('guru/update_profile');
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li>
									<a  href=#>Biology</a>
									<ul class="sub">
									<li><a  href="<?php echo site_url("guru/score")?>">Bio 1</a></li>
									<li><a  href="<?php echo site_url("guru/score")?>">Bio 2</a></li>
									</ul>
								</li>
								...
								<li>
									<a  href=#>Physics</a>
									<ul class="sub">
										<li><a  href="<?php echo site_url("guru/optic")?>">Alat Optik</a></li>
										<li><a  href="<?php echo site_url("guru/score")?>">Magnet</a></li>
									</ul>
								</li>
							</ul>
						</li>
						  ...
						  <section class="panel">
							  <div class="user-heading round">
								...
								<ul class="nav nav-pills nav-stacked">
									<li class="active"><a href="<?php echo site_url("guru/profile")?>"> <i class="icon-user"></i> Profile</a></li>
									...
									<li><a href="<?php echo site_url("guru/profile_edit")?>"> <i class="icon-edit"></i> Edit profile</a></li>
								</ul>
							...
							<section class="panel">
								...
								<div class="panel-body bio-graph-info">
									...
									<div class="row">
										...
										<div class="bio-row">
											<p><span>Major </span>: <?php echo $row->kelas; ?></p>
										</div>
										<div class="bio-row">
